...
@section('conteudo')
    ...
    {{--FORMULARIO DE PESQUISA--}}
        <form action="{{route ('lancamento.index')}}" method="get">
            {{-- @csrf --}}
            <input type="text" name="pesquisar" id="pesquisar" value="{{old('pesquisar')}}" placeholder="Digite a palavra chave da busca">
            <input type="date" name="dt_inicio" id="dt_inicio" placeholder="dt_inicio">
            <input type="date" name="dt_fim" id="dt_fim" placeholder="dt_fim">
